...
At the start you will be able to place start and goal blocks to tell the game were you want the algorithm to, well, start and end. Later on, you can place solid blocks to block the algorithm's path.
...
- F - Toggle labels on blocks (on by default)
- Q - Reset the game

## Notes
You are not allowed to place solid blocks as soon as the algorithm adds a orange block.
